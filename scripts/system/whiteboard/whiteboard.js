...
(function() {
    ...
    Whiteboard.prototype = {
        ...
        createMarkers: function() {
            ...
            printd("createMarkers end" + JSON.stringify(modelURLS));
        },
        createMarker: function(modelURL, markerPosition, markerColor) {
            ...
            printd("createMarker " + JSON.stringify(markerProperties));

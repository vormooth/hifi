(function() {
    ...
    function printd(str) {
    if (logEnabled)
        print("whiteboard.js-(nohandgrab) " + str);
    }
    ...
    HandyAttacher.prototype = {
        ...
        update: function(deltaTime) {
            ...
            for (var hand = 0; hand < HAND_COUNT; hand++) {
                ...
                //printd("update hand : " + hand + " position: " + JSON.stringify(worldHandPosition) + " _this.position:" + JSON.stringify(_this.properties.position));
                if (Vec3.distance(_this.properties.position, worldHandPosition) > _this.ignoreDistance) {
                    //printd('update ' + Vec3.distance(_this.properties.position, worldHandPosition) + '>' + _this.ignoreDistance)
                    continue;
                }
                ...
                //printd('update outerDistance' + JSON.stringify(outerDistance));
